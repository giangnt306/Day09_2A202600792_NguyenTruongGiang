...
def check_routing(state: State) -> list[Send]:
    ...
    if any(kw in question_lower for kw in ["data", "privacy", "gdpr", "dữ liệu", "rò rỉ", "data breach", "bảo vệ dữ liệu"]):
...
Tập trung: GDPR, data protection, quyền riêng tư, data breach notification, xử lý dữ liệu cá nhân, PDPA."""
